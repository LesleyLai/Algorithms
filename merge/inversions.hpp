...
size_t count_inversions(RandomIt first, RandomIt last, Compare comp=std::less<typename RandomIt::value_type>{});

template<class Container>
size_t count_inversions(Container& c) {
    return count_inversions(c.begin(), c.end());
}

namespace details {
template<class RandomIt, class Compare>
size_t count_split_inversions(RandomIt first, RandomIt middle, RandomIt last, RandomIt scratch, Compare comp) {
    size_t inversions = 0;
...
template<class RandomIt, class Compare>
size_t count_inversions_helper(RandomIt first, RandomIt last, RandomIt scratch, Compare comp) {
...
template<class RandomIt, class Compare>
size_t count_inversions(RandomIt first, RandomIt last, Compare comp) {
